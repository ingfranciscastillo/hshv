  ...
  return (
    <form onSubmit={handle} className="space-y-4">
      ...
      <div className="flex items-center gap-3">
        <Switch id="fc" checked={fc} onCheckedChange={setFc} disabled={loading} />
        <Label htmlFor="fc" className="text-sm text-muted-foreground cursor-pointer">
          Reintentar con Firecrawl si el fetch directo falla (requiere conector)
        </Label>
      </div>
    </form>
  );
